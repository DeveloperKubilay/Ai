...
buradaki sistem eski versiyondur<br>
sıfırdan ai geliştirmenize yarar<br>
ancak normal bir kullanıcının sıfırdan ai geliştirmesi pek önerilmez<br>
çünki matematik gibi problemlerde verdiğiniz metine özel veri üretmede sıkıntı yaşamanız yüksek ihtimaldir (modeliniz büyük ihtimal ezber yapar eğer devam ederseniz). <br>büyük modeller sizin için açık kaynaklı Instruck modelleri paylaşır kullanmanız daha çok önerilir
